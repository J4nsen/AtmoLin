    ...
    AbstractMode(leds, parent)
{
    ...
    //m_cw->setSizePolicy(QSizePolicy(QSizePolicy::Expanding, QSizePolicy::Preferred));
    ...
    //
    //m_layout->addRow("Color", m_cw);
    //m_layout->addRow("Area", m_spinBox);
    m_layout->addWidget(m_cw);
